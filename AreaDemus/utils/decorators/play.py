...
from AreaDemus.utils.inline import botplaylist_markup
        ...
        if await is_maintenance() is False:
            if message.from_user.id not in SUDOERS:
                return await message.reply_text(
                    text=f"{app.mention} is under maintenance, visit <a href={SUPPORT_CHAT}>Support Chat</a> for kkowing the reason.",
